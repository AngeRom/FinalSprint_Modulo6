    ...
    <div class="col-lg-4 col-md-6 col-sm-8">
      <form class="register-form" action="formularioRegistro" method="POST" >
        ...
        <div class="form-group">
          ...
          <input name="username" type="text" id="username" class="form-control" placeholder="Ingresa Usuario" required>
        </div>
        <br>
        <div class="form-group">
          <label class="mb-3" for="password">Contraseña</label>
          <input name="password" type="password" id="password" class="form-control" placeholder="Ingresa tu contraseña" required>
        </div>
        <div class="form-group">
